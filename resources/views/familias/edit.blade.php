                                ...
                                <form id="editar-familia" action="{{ route('familias.update', $familia->uuid) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3 required">
                                        ...
                                        <div class="mb-2 text-center">
                                            <img loading="lazy" width="100" src="{{ URL::to('/') }}/images/{{ $familia->imagen }}" alt="{{ $familia->nombre }}" class="img-thumbnail" />
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="mostrar_en_cocina" name="mostrar_en_cocina" value="1" {{ $familia->mostrar_en_cocina ? 'checked' : '' }}>
