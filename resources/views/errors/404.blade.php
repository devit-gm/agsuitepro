        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-none fondo-rojo">
                    <i class="bi bi-exclamation-triangle"></i> {{ __('Página no encontrada') }}
                </div>
                ...
                <div class="card-body text-center py-5">
                    ...
                    <h2 class="mb-3">{{ __('Página no encontrada') }}</h2>
                    <p class="text-muted mb-4">
                        {{ __('Lo sentimos pero esta página no está disponible.') }}
                    </p>
