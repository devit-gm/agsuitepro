            ...
            <div class="card flex-fill">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2 d-md-flex justify-content-end">
                        ...
                        @endphp
                        @if (Auth::user()->role_id < 4) <button class="btn btn-lg btn-success fs-3" onclick="if(confirm('Se marcará como facturado todo lo pendiente. ¿Desea continuar?')){location.href=location.href='{{ $ruta }}'}"><i class="bi bi-cash-coin"></i> Facturar pendiente</button>
                            @endif
                            @endif
                    </div>
